const experiences = [
  {
    ...
    title: {
      ID: "Afnane studio | Pengembang Aplikasi Mobile",
      EN: "Afnane studio | Mobile Application Developer",
    },
    description: {
      ID: "Saya bertanggung jawab mengembangkan fitur, widget, serta memperbaiki bug pada aplikasi mobile berbasis React Native, Kotlin (Android), dan Swift (iOS). Proyek yang saya tangani mencakup optimalisasi performa, integrasi API, dan dukungan tampilan lintas platform. Selain itu, saya juga memastikan kompatibilitas dan stabilitas aplikasi di berbagai perangkat.",
      EN: "I am responsible for developing features, widgets, and fixing bugs in mobile applications using React Native, Kotlin (Android), and Swift (iOS). My work includes performance optimization, API integration, and ensuring cross-platform UI consistency. I also focus on maintaining compatibility and app stability across various devices.",
    },
    link: "https://www.afnane.net/",
    imageUrl:
      "https://media.licdn.com/dms/image/v2/C4D0BAQExkaLV80pSjg/company-logo_200_200/company-logo_200_200/0/1631352584315?e=1756339200&v=beta&t=wRjJbwD39A9SxS2uzCoVfBqE-wzN9yTDd_bcAFMP7vc",
  },
  {
    years: {
      ID: "2023 - 2025",
